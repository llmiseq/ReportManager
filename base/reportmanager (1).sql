...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2025 at 01:50 PM
...
(8, 'OW+12546', 'Bosch', '2025-03-25', 1, 'sdfdsfsdf', 'dfsfsdf', 'fdsfsdfdsf', 435);
...
--
ALTER TABLE `raporty`
  MODIFY `id_raportu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `roboty`
--
ALTER TABLE `roboty`
  MODIFY `id_roboty` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `urzadzenia`
--
ALTER TABLE `urzadzenia`
  MODIFY `id_urzadzenia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
